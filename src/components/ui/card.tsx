...
>(({ className, glass, hover, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-white/[0.06] bg-white/[0.03] text-card-foreground",
      glass && "backdrop-blur-xl bg-white/[0.05] border-white/10",
      hover && "hover:border-white/10 hover:bg-white/[0.06] transition-all duration-200 cursor-pointer",
      className
    )}
    {...props}
  />
